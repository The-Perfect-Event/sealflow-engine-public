...
export function meta({ params: { slug } }: Route.MetaArgs) {
  ...
  return [
    { title: 'Sealflow - Share' },
    { description: 'I just signed a document in style with Sealflow!' },
    {
      property: 'og:title',
      content: 'Sealflow - Join the open source signing revolution',
    },
    {
      property: 'og:description',
      content: 'I just signed with Sealflow!',
    },
    {
      property: 'og:type',
      content: 'website',
