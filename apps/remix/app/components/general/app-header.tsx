  ...
  return (
    ...
    >
      <div className="mx-auto flex w-full max-w-screen-xl items-center justify-between gap-x-4 px-4 md:justify-normal md:px-8">
        ...
        >
          {/* Sealflow fork: h-10 (was h-6 upstream) so the wordmark fills the
              navbar. Dark-mode legibility is handled inside BrandingLogo (white
              chip), replacing the old runtime brightness/saturate hot-patch
              (sealflow#19). */}
