...
// Real value is set per-deployment via NEXT_PUBLIC_SUPPORT_EMAIL (prod: hasham@theperfectevent.com).
// Neutral platform fallback only — never a tenant address hardcoded in shared code.
export const SUPPORT_EMAIL = env('NEXT_PUBLIC_SUPPORT_EMAIL') ?? 'support@sealflow.app';
...
/**
 * Whether this Sealflow instance is running in CSC (Cloud Signature Consortium) mode.
 *
