...
export const DocumentRecipientSignedEmailTemplate = ({
  ...
  const previewText = match(recipientRole)
    .with(RecipientRole.APPROVER, () => msg`${recipientReference} has approved ${documentName}`)
    .otherwise(() => msg`${recipientReference} has signed ${documentName}`);
